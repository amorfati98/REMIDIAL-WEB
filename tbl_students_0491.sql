...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2022 at 05:36 PM
...
--
-- Table structure for table `tbl_students_0491`
--

CREATE TABLE `tbl_students_0491` (
  `id` int(3) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0491`
--

INSERT INTO `tbl_students_0491` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0491`
--
ALTER TABLE `tbl_students_0491`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0491`
--
ALTER TABLE `tbl_students_0491`
